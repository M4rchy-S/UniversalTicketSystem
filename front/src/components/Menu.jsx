...
const Menu = ({setLogin, role}) =>{
    ...
    return(
        <>
            <ul className="menu rounded-box w-56">
                ...
                <li>
                    <Link to='/' className='nav-button'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className='icons'>
                ...
                <li>
                    <a onClick={()=>document.getElementById('logout-account-modal').showModal()} className='nav-button'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" className="icons">
            ...
            <dialog id="logout-account-modal" className="modal">
                <div className="modal-box modal-stretch">
                    ...
                    <div className="modal-form deletion-form">
                        ...
                        <button className="btn btn-outline btn-error" onClick={LogOutHandle}>
                            { t('Yes') }
                        </button>

                        <button className="btn btn-outline btn-success" onClick={() => document.getElementById('logout-account-modal').close()}>
                            { t('No') }
                        </button>
